...
def start():
    start=([
        ...
        html.Button(id='TotalDatafb',style={'text-align': 'center', 'font-size': '15px', 
        ...
        html.Div([
                dbc.Row(
                    [
                    dbc.Col(dcc.Dropdown(id='Statefb',options=createDroplist(getStatelist(st1work),'State'), value='ALL',multi=True,placeholder="State",
                                        style={'height': '100%', 'width': '100%' , 'font-size': '15px' })
                            ,style={'padding-right': '0%','padding-left':'0%'},className='dropdown',md=dict(size=2)),
                    
                    
                    
                    dbc.Col(dcc.Dropdown(id='Locationfb',options=createDroplist(getlocationlist(st1work),'District'), value='ALL',multi=True,placeholder="District"
                                        ,style={'height': '100%', 'width': '100%' , 'font-size': '15px' })
                            ,style={'padding-right': '0%','padding-left':'0%'},className='dropdown',md=dict(size=2)),
                    
                    
                    dbc.Col(dcc.Dropdown(id='Castefb',options=createDroplist(getCastelist(st1work) , 'Caste'), value='ALL',multi=True,placeholder="Caste", 
                                        style={'height': '100%', 'width': '100%' , 'font-size': '15px' }),
                            style={'padding-right': '0%','padding-left':'0%'},className='dropdown',md=dict(size=2)),

                    

                    dbc.Col(dcc.Dropdown(id='Religionfb',options=createDroplist(getReligionllist(st1work),'Religion'), value='ALL',multi=True,placeholder="Religion"
                                        ,style={'height': '100%', 'width': '100%' , 'font-size': '15px' })
                            ,style={'padding-right': '0%','padding-left':'0%'},className='dropdown',md=dict(size=2)),

                    dbc.Col(dcc.Dropdown(id='Genderfb',options=createDroplist(getGenderlist(st1work),'Gender'), value='ALL',multi=True,placeholder="Gender",
                                        style={'height': '100%', 'width': '100%' , 'font-size': '15px' })
                            ,style={'padding-right': '0%','padding-left':'0%'},className='dropdown',md=dict(size=2)),
                        
                     
                    dbc.Col(dcc.Dropdown(id='monthfb'
...
def barJanDhanApril(fil4 , month='October'):
    month=month
    Bardata1=fil4['Do you have health insurance coverage under Rashtriya Swasthya Bima Yojana/ Ayushman Bharat or any other government insurance scheme?'].value_counts()
...
def barUjjwalaApril(fil4 , month='October'):
    month=month
...
def funnelOldAgeJune(fil4 , month='October'):
...
def funnelWindowPensionJune(fil4, month='October'):
...
def funnelDisabilityJune(fil4, month='October'):
...
def barRationApril(fil4 , month='October'):
    month=month
        ...
        html.Div([
            ...
            dbc.Col([   
                dbc.Row([
                            ...
                            html.P("You have health insurance coverage under Rashtriya Swasthya Bima Yojana/ Ayushman Bharat or any other government insurance scheme?",style={'text-align': 'center', 'colour':'green' } ),
                            dcc.Graph(id='barJanDhanAprilfb',figure= barJanDhanApril(st1work),config=cong())] ,md=6),
                            dbc.Col([
                            ...
                            dcc.Graph(id='barRationAprilfb',figure= barRationApril(st1work),config=cong())],md=6),
            ...
            dbc.Col([  
                dbc.Row([
                            ...
                            dcc.Graph(id='barUjjwalaAprilfb',figure= barUjjwalaApril(st1work),config=cong())],md=6),
                            ...
                            dcc.Graph(id='pielevel2chart1fb',figure= pielevel2chart1(st1work),config=cong() )
                            ],md=6),
            ...
            dbc.Row(
                [
                    dbc.Col(dcc.Graph(id='graphfb',figure= quick_plot1(st1work),config=cong() ),md=6),
                    dbc.Col([
                        dbc.Row([
                        ...
                        dbc.Row([
                            ...
                            dbc.Col(dcc.Graph(id='funnelOldAgeJunefb',figure= funnelOldAgeJune(st1work),config=cong()),md=4),
                            dbc.Col(dcc.Graph(id='funnelWindowPensionJunefb',figure= funnelWindowPensionJune(st1work),config=cong()),md=4),
                            dbc.Col(dcc.Graph(id='funnelDisabilityJunefb',figure= funnelDisabilityJune(st1work),config=cong()),md=4),
                        ],justify="center", align="center"
                        )
...
@app.callback( 
    ...
    Output(component_id='Castefb', component_property='options'),
    Output(component_id='Locationfb', component_property='options'),
    Output(component_id='Religionfb', component_property='options'),
    Output(component_id='Genderfb', component_property='options'),
    Output(component_id='Statefb', component_property='options'),
    
    Output(component_id='barJanDhanAprilfb', component_property='figure'),
    
    Output(component_id='barRationAprilfb', component_property='figure'),
    
    Output(component_id='barUjjwalaAprilfb', component_property='figure'),
    
    Output(component_id='funnelOldAgeJunefb', component_property='figure'),
    Output(component_id='funnelWindowPensionJunefb', component_property='figure'),
    Output(component_id='funnelDisabilityJunefb', component_property='figure'),
                             
    Output(component_id='pielevel2chart1fb', component_property='figure'),
    
    Output(component_id='graphfb', component_property='figure'),
    
    Output(component_id='TotalDatafb', component_property='children'),
    #Output(component_id='barlevel1chart2', component_property='figure'),
   
    Input(component_id='Castefb', component_property='value'),
    Input(component_id='Locationfb', component_property='value'),
    Input(component_id='Religionfb', component_property='value'),
    Input(component_id='Genderfb', component_property='value'),
    Input(component_id='Statefb', component_property='value'),
    Input(component_id='monthfb', component_property='value'),
